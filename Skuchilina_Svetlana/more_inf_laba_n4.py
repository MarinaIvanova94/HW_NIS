...
tree.write("D:\NIS\HW_NIS\Skuchilina_Svetlana\more_inf_lba_n4.xml", encoding='UTF-8')
f = open("D:\NIS\HW_NIS\Skuchilina_Svetlana\more_inf_lba_n4.xml", 'r')
tree = etree.parse(f)
root = tree.getroot()
output = etree.tostring(root, pretty_print=True, encoding='UTF-8')
f.close()
f = open('D:\NIS\HW_NIS\Skuchilina_Svetlana\more_inf_lba_n4.xml', 'w')
f.write(output)
f.close()